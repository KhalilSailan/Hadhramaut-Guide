...
<body>
    ...
    <div class="admin-layout">
        ...
        <main class="main-content">
            <!-- Top Header in Admin -->
            <header class="flex justify-between items-center mb-4 pb-4"
                style="border-bottom: 1px solid var(--border-color);">
                <h2 style="margin:0;">@yield('header_title', 'لوحة التحكم')</h2>
                <div class="flex items-center gap-2">
                    <span style="color: var(--text-muted);">أهلاً بك، <strong
                            class="text-gold">{{ auth()->user()->name ?? 'المشرف' }}</strong></span>
